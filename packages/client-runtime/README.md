...
Shared client behavior for the desktop renderer. Public APIs are organized by package
...
| --------------------- | ---------------------------------------------------------------- |
| `authorization`       | Local bearer authorization and remote session bootstrap helpers  |
