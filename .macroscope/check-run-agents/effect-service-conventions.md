...
- Keep implementation-specific names when an abstract port module contains one of several possible implementations, for example `makeNodePtyAdapter` and `layerNodePty` in a PTY adapter module.
