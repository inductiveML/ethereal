...
type EtherealDesktopBridge = Pick<
  DesktopBridge,
  | "getAppBranding"
...
const desktopBridge: EtherealDesktopBridge = {
  getAppBranding: () => {
  ...
  onMenuAction: (listener) => {
    ...
    return () => ipcRenderer.removeListener(IpcChannels.MENU_ACTION_CHANNEL, wrappedListener);
  },
  preview: {
