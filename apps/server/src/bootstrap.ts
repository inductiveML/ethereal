...
// Some inherited descriptors report EACCES when reopened through their
// filesystem path. Fall back to reading the descriptor directly, as for the
// other unsupported duplication errors.
