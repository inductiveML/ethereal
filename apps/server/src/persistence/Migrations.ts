...
import Migration0033 from "./Migrations/033_TaskContext.ts";
import Migration0034 from "./Migrations/034_TaskRuns.ts";
...
export const migrationEntries = [
  ...
  [33, "TaskContext", Migration0033],
  [34, "TaskRuns", Migration0034],
] as const;
